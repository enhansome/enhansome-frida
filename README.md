...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,439 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-09 - static and dynamic analysis synergy
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,384 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration for iOS and Android
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,085 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - A powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,439 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-09 [memory search](https://www.nowsecure.com/blog/2017/03/14/spearing-data-mobile-memory-building-better-r2frida-memory-search/)
* [Dwarf](https://github.com/igio90/Dwarf) ⭐ 1,319 | 🐛 5 | 🌐 Python | 📅 2024-05-16 - A debugger built on top of PyQt5 and frida
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,172 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-13 - A dynamic binary instrumentation tool designed for Android apps and powered by Frida
...
* [friTap](https://github.com/fkie-cad/friTap) ⭐ 537 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Decrypts and logs a process's SSL/TLS traffic on all major platforms. Beside this it intercepts the generation of encryption keys used by SSL/TLS and logs them as a SSLKEYLOGFILE.
...
More info on the [guidelines](https://github.com/dweinstein/awesome-frida/blob/master/CONTRIBUTING.md) ⭐ 3,529 | 🐛 5 | 📅 2026-04-10
