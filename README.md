...
* [frida-compile](https://github.com/frida/frida-compile) ⭐ 229 | 🐛 35 | 🌐 JavaScript | 📅 2026-03-27 - Compile a Frida script comprised of one or more Node.js modules
...
* [frida-push](https://github.com/AndroidTamer/frida-push) ⭐ 43 | 🐛 12 | 🌐 Python | 📅 2022-12-26 - Automatically `adb push` the correct frida-server matching your current frida installation.
...
* [frida-load](https://github.com/frida/frida-load) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2017-08-09 - Load a Frida script comprised of one or more Node.js modules (Deprecated, use [frida-compile](https://github.com/frida/frida-compile) ⭐ 229 | 🐛 35 | 🌐 JavaScript | 📅 2026-03-27)
...
* [0xdea/frida-scripts](https://github.com/0xdea/frida-scripts) ⭐ 1,657 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-02 - instrumentation scripts to facilitate reverse engineering of android and iOS Apps.
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,437 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-04 - static and dynamic analysis synergy
...
* [XposedFridaBridge](https://github.com/monkeylord/XposedFridaBridge) ⭐ 212 | 🐛 3 | 🌐 JavaScript | 📅 2021-09-24 - A frida script implement XposedBridge & load xposed modules, without installing xposed framwork.
...
* [NLUUG 2015](https://www.nluug.nl/activiteiten/events/nj15/index.html):
  ...
  · [Demos](https://github.com/frida/frida-presentations/tree/master/NLUUG2015) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-18
...
* [ZeroNights 2015](http://2015.zeronights.org/):
  ...
  · [Demos](https://github.com/frida/frida-presentations/tree/master/ZeroNights2015) ⭐ 103 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-18)
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,365 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration for iOS and Android
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,080 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - A powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,437 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-04 [memory search](https://www.nowsecure.com/blog/2017/03/14/spearing-data-mobile-memory-building-better-r2frida-memory-search/)
* [Dwarf](https://github.com/igio90/Dwarf) ⭐ 1,318 | 🐛 5 | 🌐 Python | 📅 2024-05-16 - A debugger built on top of PyQt5 and frida
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,171 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-04 - A dynamic binary instrumentation tool designed for Android apps and powered by Frida
...
* [friTap](https://github.com/fkie-cad/friTap) ⭐ 535 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Decrypts and logs a process's SSL/TLS traffic on all major platforms. Beside this it intercepts the generation of encryption keys used by SSL/TLS and logs them as a SSLKEYLOGFILE.
...
* [CatFrida](https://github.com/neil-wu/CatFrida) ⭐ 118 | 🐛 1 | 🌐 C | 📅 2021-01-20 - A macOS app for inspecting a running iOS app. Building with frida-swift, CatFrida provide an awesome easy way to dive into an app.
* [frida-extract](https://github.com/OALabs/frida-extract) ⭐ 115 | 🐛 1 | 🌐 JavaScript | 📅 2017-03-02 - Automatically extract and reconstruct a PE file that has been injected using the RunPE method
* [PAPIMonitor](https://github.com/Dado1513/PAPIMonitor) ⭐ 88 | 🐛 3 | 🌐 JavaScript | 📅 2024-07-04 - **P**ython **API** **Monitor** for Android apps is a tool, powered by Frida, to monitor user-selected APIs during app execution.
...
More info on the [guidelines](https://github.com/dweinstein/awesome-frida/blob/master/CONTRIBUTING.md) ⭐ 3,523 | 🐛 5 | 📅 2026-04-10

<a name="credits" />

## Credits

* This awesome list was originally based on [Awesome TensorFlow](https://github.com/jtoy/awesome-tensorflow) ⭐ 17,548 | 🐛 34 | 📅 2026-02-08
