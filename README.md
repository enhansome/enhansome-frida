...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,436 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-03 - static and dynamic analysis synergy
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,360 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration for iOS and Android
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,078 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - A powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,499 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Decrypt apps from AppStore on jailbroken devices. Supports decrypting app extensions.
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,436 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-03 [memory search](https://www.nowsecure.com/blog/2017/03/14/spearing-data-mobile-memory-building-better-r2frida-memory-search/)
* [Dwarf](https://github.com/igio90/Dwarf) ⭐ 1,318 | 🐛 5 | 🌐 Python | 📅 2024-05-16 - A debugger built on top of PyQt5 and frida
* [Dexcalibur](https://github.com/FrenchYeti/dexcalibur) ⭐ 1,170 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-03 - A dynamic binary instrumentation tool designed for Android apps and powered by Frida
...
More info on the [guidelines](https://github.com/dweinstein/awesome-frida/blob/master/CONTRIBUTING.md) ⭐ 3,521 | 🐛 5 | 📅 2026-04-10
