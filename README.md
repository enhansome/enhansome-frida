...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-16 - static and dynamic analysis synergy
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,394 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - Runtime Mobile Exploration for iOS and Android
...
* [r2frida](https://github.com/nowsecure/r2frida) ⭐ 1,440 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-16 [memory search](https://www.nowsecure.com/blog/2017/03/14/spearing-data-mobile-memory-building-better-r2frida-memory-search/)
...
* [friTap](https://github.com/fkie-cad/friTap) ⭐ 540 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Decrypts and logs a process's SSL/TLS traffic on all major platforms. Beside this it intercepts the generation of encryption keys used by SSL/TLS and logs them as a SSLKEYLOGFILE.
