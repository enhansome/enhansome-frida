...
* [objection](https://github.com/sensepost/objection) ⭐ 9,392 | 🐛 58 | 🌐 Python | 📅 2026-07-23 - Runtime Mobile Exploration for iOS and Android
* [Runtime Mobile Security (RMS)](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,086 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - A powerful web interface that helps you to manipulate Android and iOS Apps at Runtime
...
* [bagbak](https://github.com/ChiChou/bagbak) ⭐ 1,504 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-24 - Decrypt apps from AppStore on jailbroken devices. Supports decrypting app extensions.
...
* [friTap](https://github.com/fkie-cad/friTap) ⭐ 538 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Decrypts and logs a process's SSL/TLS traffic on all major platforms. Beside this it intercepts the generation of encryption keys used by SSL/TLS and logs them as a SSLKEYLOGFILE.
